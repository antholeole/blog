...
TODO: compile this into an example project that I can link to.
...
The task at hand? Build a container that runs [jest](https://jestjs.io/) tests; that is, the final container should do something like, in the painful irreproduciblilty that is Dockerfiles:
