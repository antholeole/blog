One of my issues with JS is the fact that there is no out-of-the-box priority queue: Today, I learned that there's a PQ in leetcode that we can use, which is very helpful.
